...
export function loadAllCommands() {
  ...
  // Google Drive
  commands.set('gdrive', gdrivePlugin);
  commands.set('gupload', gupload);
  commands.set('glist', glist);
  commands.set('gview', gview);
  commands.set('gdownload', gdownload);
  commands.set('gmkdir', gmkdir);
  commands.set('gdelete', gdelete);
  commands.set('gsearch', gsearch);
